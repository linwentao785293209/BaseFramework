...
namespace BaseFramework
{
    public class ExcelTool
    {
        ...
        /// excel文件存放的路径
        /// </summary>
        public static string EXCEL_PATH = Application.dataPath + "/BaseFramework/Excel/";

        /// <summary>
        /// 数据结构类脚本存储位置路径
        /// </summary>
        public static string DATA_CLASS_PATH = Application.dataPath + "/BaseFramework/ExcelDataClass/";

        /// <summary>
        /// 容器类脚本存储位置路径
        /// </summary>
        public static string DATA_CONTAINER_PATH = Application.dataPath + "/BaseFramework/ExcelDataContainer/";
        ...
        [MenuItem("ExcelTool/GenerateExcelClassAndContainer")]
